...
function runTests(test) {
	...
	fs.readdirSync(__dirname + test.dir).map(function (file) {
		if (file[0] === ".") return false;
		if (file.substr(-5) === ".json") return JSON.parse(fs.readFileSync(__dirname + test.dir + file));
...
//run all tests
["./02-dom_utils.js"].map(require).forEach(runTests);
...
//# sourceMappingURL=00-runtests-compiled.js.map